...
const Register = ({ closeRegister }) => {
    ...
    async function checkEmailExists(email) {
        try {
            ...
            const response = await axios.get(`https://tongbro.ddns.net:8080/api/v1/employee/check-email?email=${encodedEmail}`);
    ...
    async function registeraction(event) {
        ...
        try {
            // 發送 POST 請求進行註冊
            await axios.post("https://tongbro.ddns.net:8080/api/v1/employee/registeraction", {
