...
const Pay = () => {
    ...
    useEffect(() => {
        if (rowData) {
            ...
            const addData = async () => {
                try {
                    const response = await axios.post(`https://tongbro.ddns.net:8080/api/v1/pay/paydata`, rowData);
    ...
    useEffect(() => {
        if (dataAdded && formid) { // Check if data has been added
            const fetchData = async () => {
                try {
                    const response = await axios.get(`https://tongbro.ddns.net:8080/api/v1/pay/getpaydata`, {
                        params: { formid }
                    });
    ...
    async function payaction(event) {
        ...
        setIsLoading(true);
        try {
            const response = await axios.get("https://tongbro.ddns.net:8080/payment", {
                params: { formid, total }
            });
    ...
    async function linepayAction() {
        ...
        try {
            const response = await axios.post("https://tongbro.ddns.net:8080/api/linepay/request", null, {
                params: { formid, total }
            });
            console.log("Received response data:", response.data);
